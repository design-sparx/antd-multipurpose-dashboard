...
const { data: projectsData = [] } = useFetchData<Projects[]>('../mocks/Projects.json');
```
...
const { data: tasksListData = [] } = useFetchData<Tasks[]>('../mocks/TasksList.json');
const { data: projectsData = [] } = useFetchData<Projects[]>('../mocks/Projects.json');
const { data: notificationsData = [] } = useFetchData<Notifications[]>('../mocks/Notifications.json');
```
