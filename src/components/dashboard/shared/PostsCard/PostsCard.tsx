import {Alert, Avatar, Button, CardProps, Col, Divider, Flex, Image, List, Row, Space, theme, Typography} from "antd";
...
const PostsCard = ({as, data, error, loading, ...others}: Props) => {
    ...
    return (
        <Card
            className="posts-lists-card card"
            {...others}
        >
            {error ?
                <Alert
                            ...
                            renderItem={(item: Posts) => (
                                as === "active" ?
                                    <List.Item
                                        key={item.title}
                                        actions={[
                                            <IconText icon={LikeOutlined} text={item.likes_count}
                                                      key="list-vertical-star-o"/>,
                                            <IconText icon={CommentOutlined} text={item.comments_count}
                                                      key="list-vertical-like-o"/>,
                                            <IconText icon={ShareAltOutlined} text={item.shares_count}
