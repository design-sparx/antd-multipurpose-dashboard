            ...
            <Row gutter={16}>
                <Col span={8}>
                    <Space {...SPACE_PROPS}>
                        ...
                        />
                        <Tooltip title={`${inProgress.length} / ${ProjectsData.length} active`}>
                            <Progress
                                percent={Number(((inProgress.length / ProjectsData.length) * 100).toFixed(2))}
                                {...PROGRESS_PROPS}
                            />
                        </Tooltip>
                    </Space>
                ...
                <Col span={8}>
                    <Space {...SPACE_PROPS}>
                        ...
                        <Tooltip title={`${onHold.length} / ${ProjectsData.length} on hold`}>
                            <Progress
                                percent={Number(((onHold.length / ProjectsData.length) * 100).toFixed(2))}
                                {...PROGRESS_PROPS}
                            />
                        </Tooltip>
                    </Space>
                ...
                <Col span={8}>
                    <Space {...SPACE_PROPS}>
                        ...
                        />
                        <Tooltip title={`${completed.length} / ${ProjectsData.length} completed`}>
                            <Progress
                                percent={Number(((completed.length / ProjectsData.length) * 100).toFixed(2))}
                                {...PROGRESS_PROPS}
                            />
                        </Tooltip>
                    </Space>
