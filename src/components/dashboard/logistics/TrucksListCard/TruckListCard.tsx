...
const TruckListCard = ({data, ...others}: Props) => {
    return (
        <Card
                        ...
                        <Row gutter={16}>
                            <Col span={10}>
                                <Space direction="vertical">
                                    <Badge color="purple" text={<Typography.Text>{item.origin}</Typography.Text>}/>
                                    <Badge color="cyan" text={<Typography.Text>{item.destination}</Typography.Text>}/>
                                </Space>
                            </Col>
                            <Col span={6}>
                                <Space direction="vertical">
