...
import {Alert, Card as AntdCard, CardProps, Col, List, Row, Segmented, Space, theme, Typography} from "antd";
        ...
        >
            {error ?
                ...
                (loading ?
                        <Loader/> :
                        <>
                            <div className="text-capitalize text-center" style={{marginBottom: "1rem"}}>
                                <Segmented
                                    size="large"
                                ...
                                {data?.map((d, i) => (
                                    <Col sm={24} lg={8} key={`${d.color}-${i}`}>
                                        ...
                                        >
                                            ...
                                            >
                                                $ <CountUp decimals={2} end={value === "monthly" ? d.monthly : d.annually}/>/
                                                <small
                                            ...
                                            <List
                                                header={<Typography.Text
                                                    style={textStyles(d.preferred)}>Features</Typography.Text>}
