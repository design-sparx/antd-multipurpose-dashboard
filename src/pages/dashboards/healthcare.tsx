    ...
    <div>
      ...
      <Row {...stylesContext?.rowProps}>
        ...
        <Col xs={12} sm={12} lg={6}>
          <Card style={{ height: '100%' }}>
            <Flex vertical align="center" gap="small">
              ...
              <Typography.Text type="secondary">Total Patients</Typography.Text>
            </Flex>
          </Card>
        </Col>
        <Col xs={12} sm={12} lg={6}>
        ...
        <Col xs={12} sm={12} lg={6}>
          <Card style={{ height: '100%' }}>
            <Flex vertical align="center" gap="small">
              <MedicineBoxOutlined style={{ fontSize: 24, color: '#faad14' }} />
              <Typography.Title level={3} style={{ margin: 0 }}>
        ...
        <Col xs={12} sm={12} lg={6}>
          <Card style={{ height: '100%' }}>
            <Flex vertical align="center" gap="small">
              ...
              <Typography.Text type="secondary">Critical Cases</Typography.Text>
            </Flex>
          </Card>
        </Col>

        {/* Appointments + Department Occupancy side by side */}
        <Col xs={24} lg={14}>
          <Card
        ...
        {/* Hospital Staff + Quick Stats side by side */}
        <Col xs={24} lg={16}>
          <Card
        ...
        {/* Upcoming Surgeries + Recent Activity side by side */}
        <Col xs={24} lg={12}>
          <Card title="Upcoming Surgeries" style={{ height: '100%' }}>
            <Flex vertical gap="small">
              <Flex
                justify="space-between"
                align="middle"
