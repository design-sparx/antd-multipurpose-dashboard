        ...
        <div>
            <Card title="Feedback form" style={{width: "50%"}}>
                <Flex vertical gap="middle">
                    <Text>Your input is valuable in helping us better understand your needs and tailor our
                        service accordingly</Text>
                    <Form
                        ...
                        <Row gutter={[16, 0]}>
                            <Col span={24}>
                                <Form.Item<FieldType>
                                    label=""
                                    name="rating"
                                    rules={[{required: true, message: 'Please enter your ratings!'}]}
                                >
                                    <Flex>
                                        <Rate
