        ...
        <Col span={24}>
            <Row {...context?.rowProps}>
                ...
                <Col xs={12} sm={12}>
                    ...
                    >
                        <Flex flexDirection="column">
                            <Text>We can protect you by signing you out of browsers, apps and anywhere else your account
                                is used to sign in.</Text>
                        </Flex>
                    </Card>
                </Col>
                <Col xs={12} sm={12}>
                    ...
                    >
                        <Flex flexDirection="column">
                            <Text>You can use this code to access your account if you lose access to your sign-in info.
                                Print this out and keep it in a safe place or take a picture of it.</Text>
                        </Flex>
                    </Card>
                </Col>
            </Row>
            ...
            <Card title="Change your password">
                ...
                >
                    ...
                    <Form.Item<FieldType>
                        ...
                        rules={[{required: true, message: 'Please re-input your new password!!'}]}
                    >
                        <Input.Password/>
                    </Form.Item>
