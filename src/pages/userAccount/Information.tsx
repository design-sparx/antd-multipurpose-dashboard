...
const SOCIALS = ['Facebook', 'Instagram', 'Twitter', 'LinkedIn', 'Mastodon', 'Threads', 'YouTube', 'WhatsApp', 'Tiktok', 'Telegram', 'QQ', 'WeChat']
                        ...
                        <Row gutter={[16, 0]}>
                            ...
                            <Col sm={24} lg={24}>
                                <Form.Item<FieldType>
                                    name="preferred"
                                >
                                    <Checkbox>Set as a preferred billing and shipping address</Checkbox>
                                </Form.Item>
                            </Col>
                        </Row>
