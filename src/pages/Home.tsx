        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-highlight">dashboard</span> template
              utilizing <span className="text-highlight">React</span>,{" "}
            ...
            <Card>
              <Flex gap={6} align="flex-end">
                <Text style={{ fontSize: 16, fontWeight: 500 }}>
                  <span className="text-highlight">60+</span> ready made
                  components to use.
                </Text>
