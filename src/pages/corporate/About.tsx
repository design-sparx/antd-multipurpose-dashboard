import {Alert, Card as AntdCard, Col, Flex, Image, List, Row, Typography} from "antd";
                        ...
                        <Row gutter={[8, 8]}>
                            <Col lg={8}>
                                <AntdCard hoverable={false} className="text-center">
                                    <Title className="m-0"><CountUp end={100}/> %</Title>
                                    <Text>Satisfaction</Text>
                                </AntdCard>
                            </Col>
                            <Col lg={8}>
                                <AntdCard hoverable={false} className="text-center">
                                    <Title className="m-0"><CountUp end={124}/> K</Title>
                                    <Text>Customers</Text>
                                </AntdCard>
                            </Col>
                            <Col lg={8}>
                                <AntdCard hoverable={false} className="text-center">
                                    <Title className="m-0">$<CountUp end={24}/> K</Title>
